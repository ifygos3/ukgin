...
const Testimonials = () => {
  ...
  return (
    <div className="pt-32 px-6 md:px-20">
      <h1 className="text-5xl font-bold text-yellow-400 mb-6">Testimonials</h1>
      <p className="text-gray-300 text-lg mb-10">What our members and partners say about UKGIN.</p>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {testimonials.map((t, i) => (
          <div key={i} className="bg-gray-900 p-6 rounded-2xl border border-gray-800 hover:border-yellow-400/30 transition">
            ...
            <p className="text-gray-300 italic leading-6 mb-4">"{t.text}"</p>
            <div>
